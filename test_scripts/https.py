...
# ----configuration begin ---
        ...
        # verify server certificate (ssl.PROTOCOL_SSLv2,ssl.PROTOCOL_SSLv23,ssl.PROTOCOL_SSLv3,ssl.PROTOCOL_TLSv1; comment out to use default)
